...
<html class="no-js h-100" lang="en">
  <head>
    ...
    <title>Selamat Datang </title><!-- Rencananya mau dikasih SELAMAT DATANG USERNAME DOI -->
    <meta name="description" content="A high-quality &amp; free Bootstrap admin dashboard template pack that comes with lots of templates and components.">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <link href="https://use.fontawesome.com/releases/v5.0.6/css/all.css" rel="stylesheet">
    <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
    <link rel="stylesheet" id="main-stylesheet" data-version="1.0.0" href="../../assets/css-shd/shards-dashboards.1.0.0.min.css">
    <link rel="stylesheet" href="../../assets/css-shd/extras.1.0.0.min.css">
...
-->
            ...
            <nav class="navbar align-items-stretch navbar-light bg-white flex-md-nowrap border-bottom p-0">
              <a class="navbar-brand w-100 mr-0" href="#" style="line-height: 25px;">
                <div class="d-table m-auto">
                  <img id="main-logo" class="d-inline-block align-top mr-1" style="max-width: 25px;" src="../../assets/img-shd/shards-dashboards-logo.svg" alt="Apaanke">
                  <span class="d-none d-md-inline ml-1">Panel Juragan</span>
                </div>
              </a>
              ...
              <ul class="navbar-nav border-left flex-row ">
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle text-nowrap px-3" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                    <img class="user-avatar rounded-circle mr-2" src="../../assets/img-shd/avatars/0.jpg" alt="User Avatar">
                  ...
                  <div class="card-body p-0">
                    <div class="blog-comments__item d-flex p-3">
                      <div class="blog-comments__avatar mr-3">
                        <img src="../../assets/img-shd/avatars/1.jpg" alt="User avatar" /> </div>
                    ...
                    <div class="blog-comments__item d-flex p-3">
                      <div class="blog-comments__avatar mr-3">
                        <img src="../../assets/img-shd/avatars/2.jpg" alt="User avatar" /> </div>
                      <div class="blog-comments__content">
                        <div class="blog-comments__meta text-muted">
                          <a class="text-secondary" href="#">James Johnson</a> on
                          <a class="text-secondary" href="#">Hello World!</a>
                    ...
                    <div class="blog-comments__item d-flex p-3">
                      <div class="blog-comments__avatar mr-3">
                        <img src="../../assets/img-shd/avatars/3.jpg" alt="User avatar" /> </div>
                      <div class="blog-comments__content">
                        <div class="blog-comments__meta text-muted">
                          <a class="text-secondary" href="#">James Johnson</a> on
                          <a class="text-secondary" href="#">Hello World!</a>
    ...
    <div class="promo-popup animated">
      <a href="#" class="pp-cta extra-action">
        <img src="../../assets/img/manami2.jpg"> </a>
      <div class="pp-intro-bar">HAIIII
        <span class="close">
          <i class="material-icons">close</i>
        </span>
        <span class="up">
      ...
      <div class="pp-inner-content">
        ...
        <a class="pp-cta extra-action" href="#">WhatsApp</a>
      </div>
    </div>
    ...
    <script src="../../assets/js-shd/extras.1.0.0.min.js"></script>
    <script src="../../assets/js-shd/shards-dashboards.1.0.0.min.js"></script>
    <script src="../../assets/js-shd/app/app-blog-overview.1.0.0.js"></script>
  </body>
</html>
